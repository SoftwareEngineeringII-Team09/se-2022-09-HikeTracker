...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (7, "Trail to Laghetti Verdi e Lago Paschiet", 2, "gpx/Laghetti_Verdi_e_Lago_Paschiet.gpx", 1019, 1, 1, 5.6, "02:10", 234.0, 2502.34, "Professional hiker", "Bivouac inside the Orsiera Rocciavre' Natural Park.", 61, 62);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (8, "Trail to Poggio Tre Croci Ciaspole", 2, "gpx/Poggio_Tre_Croci_Ciaspole.gpx", 1022, 1, 1, 14.3, "01:20", 1067.0, 2344.88, "Tourist", "From Borgo Vecchio (or alternatively from les Arnaud) where you leave your car, cross the bridge over the Rho, taking the military road that enters the beautiful wood.", 23, 24);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (9, "Trail to sacra di San Michele ", 2, "gpx/Sacra_di_San_Michele.gpx", 1255, 1, 1, 2.34, "01:30", 404.4, 2102.88, "Hiker", "The Sacra di San Michele evokes beauty, charm and mystery. That mystery that surrounds it since its construction.", 25, 26);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (10, "Trail to Punta Nera e Colle della Rho", 2, "gpx/Punta_Nera_e_Colle_della_Rho.gpx", 1022, 1, 1, 12.43, "02:20", 1007.0, 2202.88, "Hiker", "From the Granges della Rho, which can be reached from Bardonecchia by a moderate road, continue on the dirt road, passing by the chapel of the Madonna of Montserrato", 27, 28);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (14, "Trail to Cima del Bosco", 2, "gpx/Cima_del_Bosco.gpx", 1258, 1, 1, 5.0, "01:12", 1100.0, 2702.88, "Professional hiker", "Very interesting excursion that goes up in the mainly larch wood, at first thick then gradually more sparse up to the final panettone.", 35, 36);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (15, "Trail to Anello Val Servin ", 2, "gpx/Anello_Val_Servin.gpx", 1019, 1, 1, 4.6, "02:45", 1000.0, 2602.88, "Hiker", "Come and follow in the footsteps of this mountain epic along the ring of ValServin in the Balme basin, the highest municipality in the Valli di Lanzo.", 37, 38);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (17, "Trail to Monte Riba del Gias da Becetto ", 2, "gpx/Monte_Riba_del_Gias_da_Becetto.gpx", 4157, 4, 1, 6.45, "01:34", 1900.0, 2102.88, "Tourist", "It is possible to start from different hamlets depending on the snow: Becetto 1387 m, Morelli 1426 m, Rua' di Becetto 1535 m", 41, 42);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (18, "Trail to Borgata Rua-Cima di Crosa ", 2, "gpx/Borgata_Rua-Cima_di_Crosa.gpx", 4205, 4, 1, 10.4, "03:10", 1320.0, 2502.88, "Hiker", "Possibility to start also from Becetto, adding just under 200 m to the altitude difference.", 43,44);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (21, "Trail to Laghi Paione", 2, "gpx/Laghi_Paione.gpx", 103012, 103, 1, 9.2, "03:00", 1700.0, 2802.88, "Professional hiker", "The three Paione lakes are located at different levels and the waters of the upper lake feed the middle lake and so on, up to the lower one.", 49,50);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (22, "Trail to Rifugio Paolo Daviso", 2, "gpx/Rifugio_Paolo_Daviso.gpx", 1019, 1, 1, 8.2, "02:20", 1804.4, 2402.88, "Professional hiker", "It starts from the village at the bottom of the valley of Forno Alpi Graie (60 km from Turin), it can be reached in 3 hours of walking along the excellent path n.315, with 1000 meters of elevation gain you cross streams and old pastures.", 51, 52);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (23, "Trail to pietraborga da piossasco ", 2, "gpx/Pietraborga_da_Piossasco.gpx", 1276, 1, 1, 10.4, "02:22", 3203.2, 2302.88, "Professional hiker", "From P.za San Vito (361 m) head east along via San Vito, after a few hundred meters turn left into via Monte Grappa. In this way you reach the edge of the Montano Park where the asphalt ends (1 km).", 53, 54);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (24, "Trail to Alpe Dattia da Ala ", 2, "gpx/Alpe_dattia_da_ala.gpx", 1003, 1, 1, 9.4, "02:55", 1003.20, 2402.88, "Tourist", "Easy and panoramic itinerary on the peaks of the Val d'Ala, especially on the Uia di Mondrone which dominates in the foreground.", 55, 56);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (25, "Trail to Alagna Valsesia - Sorgenti del Sesia", 2, "gpx/Alagna_Valsesia-Sorgenti_del_Sesia.gpx", 2002, 2, 1, 5.3, "01:11", 1100.0, 2702.88, "Professional hiker", "Alagna Valsesia is a comune and small village high in the Valsesia alpine valley in the province of Vercelli, Piedmont, northern Italy, ", 57, 58);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (26, "Trail to Lago di Afframont ", 2, "gpx/Lago_di_Afframont.gpx", 1019, 1, 1, 7.2, "02:40", 1564.2, 2002.88, "Professional hiker", "Beautiful walk, more demanding, in the presence of children, due to the slopes.", 59, 60);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (27, "Trail to Vallone di Massello", 2, "gpx/Vallone_di_massello.gpx", 1145, 1, 1, 11.2, "02:40", 803.7, 2150.9, "Tourist", "Trail 216 starts among the houses before the bridge and begins to climb the valley on the orographic left of the stream. Going up the valley you find yourself in front of a beautiful basin, dominated by the imposing Pis waterfall, already visible from afar. The trail heads straight at first towards the base of the waterfall; then it begins to go up the rocky slope to the right, passing near the Lausoun mountain huts.", 63, 64);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (28, "Trail to Monte Chaberton", 2, "gpx/Chaberton.gpx", 1270, 1, 1, 15.0, "05:50", 1280, 1850, "Professional hiker", "Take the road to the right, immediately after the French border, leave your car in one of the many spaces on the right. The walking itinerary starts from a mule track on the left, equipped with a barrier, near a wooden sign illustrating the history of the Chaberton.", 65, 66);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (29, "Trail to Bivacco Boarelli e laghi delle Forcioline", 2, "gpx/Sentiero_per_Bivacco_Boarelli_e_laghi_delle_Forcioline.gpx", 4172, 4, 1, 15.0, "06:30", 1200, 2820, "Professional hiker", "We turn right entering the Forciolline valley and after about 50m we meet a second crossroads where we keep right in the direction of the Boarelli shelter which is about 2.30 hours from here.", 67, 68);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (30, "Trail to Rocche San Martino and Monte Soffietto", 2, "gpx/Rocche_di_san_martino.gpx", 1007, 1, 1, 6.5, "02:55", 460, 1448, "Tourist", "Reach the bottom of the Nero hamlet and park the car in the square that marks the end of the road. Take the path that descends to your right and continue along the wide roadway. Characteristic of this stretch is the beech forest.", 69, 70);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (31, "Trail to Monte Freidour", 2, "gpx/Anello_monte_freidour.gpx", 1272, 1, 1, 8.5, "05:00", 596, 1445, "Hiker", "Following the trail and the indications on the signs, you reach Colle Ciardonet (about 1080 meters above sea level), from which you continue along the forest road that develops to the right, in the direction of the Melano refuge (Casa Canada).", 71, 72);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (32, "Trail to Roc d'le Masche", 2, "gpx/Roc_dle_masche.gpx", 1075, 1, 1, 9.9, "01:15", 340, 1570, "Tourist", "The route begins by crossing a pasture area, and then climbs the slopes in the woods. The path is easily identifiable thanks to the numerous white-red signs and trail markers. Gradually the forest thins out and you reach a rocky ledge, a panoramic point", 73, 74);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (33, "Trail to Bric Costa Rossa", 2, "gpx/Sentiero_per_Bric_Costa_Rossa.gpx", 4110, 4, 1, 14.0, "08:30", 1350, 2403, "Professional hiker", "The Bisalta, Cuneo's symbol mountain, is clearly distinguishable along the plain towards the city by its characteristic profile with two peaks: Cima Besimauda 2230m and Bric Costa Rossa 2403m.", 75, 76);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (34, "Trail to Rifugio Quintino Sella and Viso Mozzo", 2, "gpx/Sentiero_per_Rifugio_Quintino_Sella_e_Viso_Mozzo.gpx", 4078, 4, 1, 14.5, "07:30", 600, 2020, "Hiker", "After leaving the car in the large Pian del Re car park, we walk along the path that heads towards the source of the Po and then pass it by continuing along an initial short uphill stretch that allows us to reach Lake Fiorenza at an altitude of approximately 2113m. (25 min from Pian del Re)", 77, 78);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (35, "Trail to Rifugio Giacoletti", 2, "gpx/Sentiero_per_il_Rifugio_Giacoletti.gpx", 4078, 4, 1, 8.0, "04:30", 700, 2741, "Tourist", "Leave the car in the Pian del Re car park (cost €10 per day), walk along path V16 with indications for Colle delle Traversette for about 700m as far as the crossroads where we turn left continuing on path V17 to the Giacoletti refuge.", 79, 80);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (36, "Trail to Stagno del Pre'", 2, "gpx/Stagno_del_pre.gpx", 1177, 1, 1, 12.8, "03:20", 160, 700, "Tourist", "A pleasant and quiet path, particularly suitable when you don't want to practice great differences in altitude. The path to the Stagno di Pre' extends over a stretch of the Cammino di Oropa, at the foot of the Serra di Ivrea.", 81, 82);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (37, "Trail to Rifugio Bertorello", 2, "gpx/Bertorello.gpx", 4157, 4, 1, 5.0, "01:45", 205, 1375, "Tourist", "The starting point can be reached by taking the road to Pian Mune' from Paesana. After about 7km you reach San Lorenzo at 1080m above sea level, continue by car for about 1200m until you reach a hairpin bend, from which the dirt road branches off to the left   for Rifugio Bertorello.", 83, 84);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (38, "Trail to Rifugio Pontese", 2, "gpx/Rifugio_Pontese.gpx", 1134, 1, 1, 6.0, "01:25", 370, 2217, "Hiker", "Once you arrive at the level of the dam you will immediately find the signs indicating the path to the Rifugio Pontese. The route initially runs along the lake, then a steep climb will follow, which will allow you to admire the splendid panorama from above.", 85, 86);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (39, "Trail to Croce del faggio", 2, "gpx/Croce_del_faggio.gpx", 1134, 1, 1, 5.0, "01:10", 340, 1400, "Hiker", "The Path to the Croce del Beech is really simple and easily identifiable. It's short, which makes it perfect for beginners and to be ridden all year round.", 87, 88);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (40, "Trail to Fondo and Tallorno", 2, "gpx/Fondo_e_tallorno.gpx", 1278, 1, 1, 4.6, "01:10", 200, 1222, "Tourist", "The path to the Fondo and Tallorno waterfall starts on the left of the bar over the bridge and runs alongside the river on a clearly visible mule track.", 89, 90);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (41, "Trail to Rifugio Arlaud", 2, "gpx/Rifugio_Arlaud.gpx", 1175, 1, 1, 10.0, "03:20", 250, 1800, "Tourist", "The route develops within the Gran Bosco di Salbertrand Natural Park, it is truly suggestive in winter because the snow that covers the trees is a unique spectacle.", 91, 92);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (42, "Trail to Rifugio Amprimo", 2, "gpx/Amprimo.gpx", 1245, 1, 1, 4.53, "01:25", 120, 1385, "Tourist", "The path to the Amprimo Hut from the town of Cortavetto is an easy destination for everyone, even those approaching the mountain for the first time, but no less fascinating for this.", 93, 94);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (43, "Anello Augusto Monti", 2, "gpx/Sentiero_Augusto_Monti.gpx", 1115, 1, 1, 8.5, "02:30", 270, 814, "Tourist", "The start of the itinerary is in the immediate vicinity of the hamlet, there are panels that intend to show the origin of the itinerary.", 95, 96);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (44, "Trail to Monte Muretto", 2, "gpx/Monte_Muretto.gpx", 1191, 1, 1, 4.3, "01:40", 270, 820, "Tourist", "Particularly easy excursion and suitable for the whole family, also for the beautiful panorama visible from the top, obviously if the weather permits.", 97, 98);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (45, "Trail to Lago Fauri", 2, "gpx/Lago_Fauri.gpx", 1201, 1, 1, 22.5, "07:30", 1273, 2857, "Hiker", "ou reach the locality of Pattemouche, shortly after the main town of Pragelato, and continue by car along the road until you reach a large dirt clearing, before a bridge over the Chisone stream.", 99, 100);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (46, "Trail to Colle della Croce Intror", 2, "gpx/Sentiero_per_Croce_Intror.gpx", 1272, 1, 1, 13.5, "08:00", 1100, 1947, "Hiker", "The path climbs in a beautiful wood of hazelnut and chestnut trees and gradually gives way to majestic beech trees, where in spring we will be surrounded by the melodious song of birds and in autumn by carpets of dry leaves.", 101, 102);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (47, "Trail to Cima di Bard", 2, "gpx/Cima_di_Bard.gpx", 1157, 1, 1, 14.0, "05:30", 1442, 3168, "Professional hiker", "Traveling along the SS25 from Susa in the direction of the Moncenisio pass, you pass through the hamlet of Bar Cenisio where, once you have passed the few houses present, on the left, near a concrete house, an easy-to-travel dirt road begins with an even surface , which in a short time will take you to Lake Arpone (or Lake Arpon), where this excursion begins.", 103, 104);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (48, "Trail for Colle della Crocetta", 2, "gpx/Colle_della_crocetta.gpx", 1073, 1, 1, 10.4, "05:15", 1020, 2641, "Professional hiker", "Reach the starting point of the Path for Colle della Crocetta by  setting the navigator to 'Ceresole Reale'. At this point you can decide whether to park near the dam, cross it and head towards Villa Poma on foot, or you can continue to the end of the lake, turning left behind the Massimo Mila refuge, thus lengthening the itinerary.", 105, 106);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (49, "Trial to Red lake from Cortavetto", 2, "gpx/Lago_Rosso_passando_da_rifugi_Toesca_e_Valgravio.gpx", 1245, 1, 1, 20.5, "07:30", 1100, 2280, "Professional hiker", "This loop excursion immersed in the Orsiera-Rocciavre' Nature Park offers beautiful landscape views and a route that is always very varied and never monotonous.", 107, 108);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (50, "Trail to lake Mongioia and Monte Mongioia", 2, "gpx/Lago_e_Monte_Mongioia.gpx", 4017, 4, 1, 15.0, "08:00", 1250, 1858.365722999999889, "Hiker", "After Chiazale, follow the signs for Sant'Anna di Bellino and once you get there, continue for another 500m following the signs for the Meleze' refuge.", 109, 110);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (51, "Trail to Baita Bai de Dones - Cinque Torri", 2, "gpx/Baita_Bai_de_Dones-Cinque_Torri.gpx", 25016, 25, 5, 7.2, "02:43", 416, 1869.34, "Hiker", "Experience this 7.2km loop trail near Cortina d'Ampezzo, Veneto. A course generally considered moderately challenging that takes an average of 2 to 43 min to complete. This is a popular trail for bird watching, cross country skiing and hiking, but you can still enjoy some solitude during the quieter times of the day. The trail is open year-round and is great to visit in any season.", 111, 112);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (52, "Trail to Croda da Lago Forcella Ambrizzola", 2, "gpx/Croda_da_Lago_Forcella_Ambrizzola.gpx", 25016, 25, 5, 12.7, "05:25", 907, 1694.71, "Professional hiker", "Try this 12.7km loop trail near Cortina d'Ampezzo, Veneto. A course generally considered challenging that takes an average of 5 to 25 min to complete. This trail is great for hiking, bird watching and trekking.", 113, 114);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (53, "Trail to Passo Tre Croci - Forcella Marcuoira", 2, "gpx/Passo_Tre_Croci-Forcella_Marcuoira.gpx", 25016, 25, 5, 13.8, "05:39", 921, 1808.35, "Professional hiker", "Check out this 13.8km loop trail near Cortina d'Ampezzo, Veneto. A course generally considered challenging that takes an average of 5 or 39 min to complete. This is a very popular area for Hiking, Camping, and Trekking, so it's likely you'll meet other people while you explore. The best times to visit this trail are from May to October.", 115, 116);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (54, "Trail to Passo Tre Croci - Lago Sorapis", 2, "gpx/Passo_Tre_Croci-Lago_Sorapis.gpx", 25016, 25, 5, 12.2, "04:16", 603, 1785.73, "Tourist", "Enjoy this 12.2km round-trip trail near Cortina d'Ampezzo, Veneto. A course generally considered moderately challenging that takes an average of 4 to 16 min to complete. This trail is great for Bird Watching, Hiking and Running, and you're unlikely to meet many other people while exploring.", 117, 118);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (55, "Trail to Tre Cime di Lavaredo - Drei Zinnen", 2, "gpx/Tre_Cime_di_Lavaredo-Drei_Zinnen.gpx", 21028, 21, 4, 10.0, "03:31", 502, 2319.63, "Tourist", "Discover this 10.0km ring trail near Misurina, Veneto. A course generally considered moderately challenging that takes an average of 3 to 31 min to complete. This is a very popular area for Hiking, Bird Watching, and Trekking, so it's likely you'll meet other people while you're exploring. The best times to visit this trail are from May to October.", 119, 120);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (56, "Trail to Campo Imperatore - Corno Grande", 2, "gpx/Campo_Imperatore-Corno_Grande.gpx", 66049, 66, 13, 9.2, "04:30", 824, 2130.44, "Professional hiker", "Enjoy this 9.2km loop trail near Assergi, Abruzzo. A course generally considered challenging that takes an average of 4 to 30 min to complete. This is a very popular area for Bird Watching, Cross Country Skiing, and Trekking, so it's likely you'll meet other people while exploring. The best times to visit this trail are from April to November.", 121, 122);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (57, "Trail to Campo Imperatore - Monte Aquila", 2, "gpx/Campo_Imperatore-Monte_Aquila.gpx", 67041, 67, 13, 6.4, "02:42", 449, 2118.4, "Tourist", "Enjoy this 6.4km round trip trail near Assergi, Abruzzo. A course generally considered moderately challenging that takes an average of 2 to 42 min to complete. This is a very popular area for cross-country skiing, hiking, and snowshoeing, so it's likely you'll meet other people as you explore. The trail is open year-round and is great to visit in any season.", 123, 124);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (58, "Trail to Fonte Vetica - Monte Camicia", 2, "gpx/Fonte_Vetica-Monte_Camicia.gpx", 67041, 67, 13, 8.7, "04:51", 951, 1609.27, "Professional hiker", "Try this 8.7km loop trail near Castel del Monte, Abruzzo. A course generally considered challenging that takes an average of 4 or 51 min to complete. This is a very popular area for Trekking, so it's likely you'll meet other people while exploring. The best times to visit this trail are from March to November.", 125, 126);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (59, "Trail to Passo del Lupo - Monte Portella", 2, "gpx/Passo_del_Lupo-Monte_Portella.gpx", 66049, 66, 13, 4.7, "01:54", 308, 2120.71, "Tourist", "Check out this 4.7km loop trail near Assergi, Abruzzo. A course generally considered moderately challenging that takes an average of 1 or 54 min to complete. This is a very popular area for cross-country skiing, hiking, and snowshoeing, so it's likely you'll meet other people as you explore. The trail is open year-round and is great to visit in any season.", 127, 128);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (60, "Trail to Rocca Calascio", 2, "gpx/Rocca_Calascio.gpx", 66082, 66, 13, 4.0, "01:30", 229, 1217.99, "Tourist", "Try this 4.0km round trip trail near Calascio, Abruzzo. A course generally considered moderately challenging that takes an average of 1 to 30 min to complete. This is a very popular area for Trekking, Mountain Biking and Road Cycling, so it is likely that you will meet other people while exploring. The best times to visit this trail are from March to November.", 129, 130);

/* Hut table data */
INSERT INTO "Hut"("hutId", "hutName", "pointId", "writerId", "city", "province", "region", "numOfBeds", "cost", "altitude", "phone", "email", "website")
VALUES (1, "Rifugio Meleze'", 1, 2, 4017, 4, 1, 50, 50.0, 1757.43, "0175 956410", "meleze@meleze.it", "www.meleze.it");
INSERT INTO "Hut"("hutId", "hutName", "pointId", "writerId", "city", "province", "region", "numOfBeds", "cost", "altitude", "phone", "email", "website")
