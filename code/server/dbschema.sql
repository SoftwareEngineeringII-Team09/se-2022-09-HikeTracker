...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (7, "Trail to Laghetti Verdi e Lago Paschiet", 2, "gpx/Laghetti_Verdi_e_Lago_Paschiet.gpx", 1118,1, 1, 5.6, "02:10", 234.0, 2502.34, "Professional hiker", "Bivacco all'interno del Parco Naturale Orsiera Rocciavrè.", 61, 62);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (8, "Trail to Poggio Tre Croci Ciaspole", 2, "gpx/Poggio_Tre_Croci_Ciaspole.gpx", 1191, 1, 1, 14.3, "01:20", 1067.0, 2344.88, "Tourist", "Da Borgo Vecchio (o in alternativa da les Arnaud) dove si lascia lauto, si attraversa il ponte sulla Rho, percorrendo la strada militare che si addentra nel bel bosco.", 23, 24);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (9, "Trail to sacra di San Michele ", 2, "gpx/Sacra_di_San_Michele.gpx",1022, 1, 1, 20.34, "01:30", 404.4, 2102.88, "Hiker", "a Sacra di San Michele evoca bellezza, fascino e mistero. Quel mistero che la avvolge fin dalla sua costruzione.", 25, 26);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (10, "Trail to Punta Nera e Colle della Rho", 2, "gpx/Punta_Nera_e_Colle_della_Rho.gpx", 1010, 1, 1, 12.43, "02:20", 1007.0, 2202.88, "Hiker", "Dalle Granges della Rho, raggiungibili da Bardonecchia per una discreta carrozzabile, proseguire sulla strada sterrata, passando per la cappelletta della Madonna DI Montserrat", 27, 28);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (14, "Trail to Cima del Bosco", 2, "gpx/Cima_del_Bosco.gpx", 1032, 1, 1, 5.0, "01:12", 1100.0, 2702.88, "Professional hiker", "scursione molto interessante che sale nel bosco principalmente di larici, prima fitto poi via via più rado fino al panettone finale .", 35, 36);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (15, "Trail to Anello Val Servin ", 2, "gpx/Anello_Val_Servin.gpx", 1001, 1, 1, 4.6, "02:45", 1000.0, 2602.88, "Hiker", "Venite a seguire le tracce di questa epopea montanara percorrendo lAnello di ValServìn nella conca di Balme, il più alto comune delle Valli di Lanzo. ", 37, 38);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (17, "Trail to Monte Riba del Gias da Becetto ", 2, "gpx/Monte_Riba_del_Gias_da_Becetto.gpx", 1002, 1, 1, 6.45, "01:34", 1900.0, 2102.88, "Tourist", "E' possibile partire da diverse frazioni a seconda dell'innevamento: Becetto 1387 m, Morelli 1426 m, Ruà di Becetto 1535 m", 41, 42);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (18, "Trail to Borgata Rua-Cima di Crosa ", 2, "gpx/Borgata_Rua-Cima_di_Crosa.gpx", 1013, 1, 1, 10.4, "03:10", 1320.0, 2502.88, "Hiker", "ossibilità di partire anche da Becetto, aggiungendo poco meno di 200 m al dislivello.", 43,44);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (21, "Trail to Laghi Paione", 2, "gpx/Laghi_Paione.gpx", 1023, 1, 1, 9.2, "03:00", 1700.0, 2802.88, "Professional hiker", "I tre laghi del Paione sono posti a livelli differenti e le acque del lago superiore alimentano il lago di mezzo e così in successione, fino a quello inferiore. ", 49,50);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (22, "Trail to rifugio paolo daviso", 2, "gpx/Rifugio_Paolo_Daviso.gpx", 1022, 1, 1, 8.2, "02:20", 1804.4, 2402.88, "Professional hiker", "Si parte dal paese a fondo valle di Forno Alpi Graie (60 km da Torino), è raggiungibile in 3 ore di marcia per lottimo sentiero n.315, con 1000 metri di dislivetto si attraversano torrenti e vecchi alpeggi.", 51, 52);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (23, "Trail to pietraborga da piossasco ", 2, "gpx/Pietraborga_da_Piossasco.gpx", 1023, 1, 1, 10.4, "02:22", 3203.2, 2302.88, "Professional hiker", "Da P.za San Vito (361 m) si parte verso Est per via San Vito, dopo poche centinaia di metri voltare a SX per via Monte Grappa. Si raggiunge così il limitare del Parco Montano dove termina l'asfalto (1 Km).", 53, 54);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (24, "Trail to alpe dattia da ala ", 2, "gpx/Alpe_dattia_da_ala.gpx", 1043, 1, 1, 9.4, "02:55", 1003.20, 2402.88, "Tourist", "Itinerario facile e panoramico sulle vette della val d'Ala, specie sull'Uia di Mondrone che domina in primo piano.", 55, 56);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (25, "Trail to Alagna Valsesia - Sorgenti del Sesia ", 2, "gpx/Alagna_Valsesia - Sorgenti del Sesia.gpx", 1045, 1, 1, 5.3, "01:11", 1100.0, 2702.88, "Professional hiker", "Alagna Valsesia is a comune and small village high in the Valsesia alpine valley in the province of Vercelli, Piedmont, northern Italy, ", 57, 58);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (26, "Trail to Lago di Afframont ", 2, "gpx/Lago_di_Afframont.gpx", 1034, 1, 1, 7.2, "02:40", 1564.2, 2002.88, "Professional hiker", "Bella passeggiata più impegnativa, in presenza di bambini, per via delle pendenze.", 59, 60);
