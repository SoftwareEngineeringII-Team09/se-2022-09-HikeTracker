...
CREATE TABLE IF NOT EXISTS "Hut" (
    ...
    "hutImage" TEXT NOT NULL CHECK(typeof(hutImage) == "text"),
    PRIMARY KEY("hutId"),
    FOREIGN KEY("pointId") REFERENCES "Point"("pointId"),
    FOREIGN KEY("writerId") REFERENCES "User"("userId")
);
...
CREATE TABLE IF NOT EXISTS "Hike" (
    ...
    "hikeImage" TEXT NOT NULL CHECK(typeof(hikeImage) == "text"),
    PRIMARY KEY("hikeId"),
    FOREIGN KEY("writerId") REFERENCES "User"("userId"),
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (21, "Trail to Laghi Paione", 5, "gpx/Laghi_Paione.gpx", 103012, 103, 1, 9.2, "03:00", 1700.0, 2802.88, "Professional hiker", "The three Paione lakes are located at different levels and the waters of the upper lake feed the middle lake and so on, up to the lower one.", 49,50);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (23, "Trail to pietraborga da piossasco ", 5, "gpx/Pietraborga_da_Piossasco.gpx", 1276, 1, 1, 10.4, "02:22", 3203.2, 2302.88, "Professional hiker", "From P.za San Vito (361 m) head east along via San Vito, after a few hundred meters turn left into via Monte Grappa. In this way you reach the edge of the Montano Park where the asphalt ends (1 km).", 53, 54);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (24, "Trail to Alpe Dattia da Ala ", 5, "gpx/Alpe_dattia_da_ala.gpx", 1003, 1, 1, 9.4, "02:55", 1003.20, 2402.88, "Tourist", "Easy and panoramic itinerary on the peaks of the Val d'Ala, especially on the Uia di Mondrone which dominates in the foreground.", 55, 56);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (26, "Trail to Lago di Afframont ", 5, "gpx/Lago_di_Afframont.gpx", 1019, 1, 1, 7.2, "02:40", 1564.2, 2002.88, "Professional hiker", "Beautiful walk, more demanding, in the presence of children, due to the slopes.", 59, 60);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (39, "Trail to Croce del faggio", 5, "gpx/Croce_del_faggio.gpx", 1134, 1, 1, 5.0, "01:10", 340, 1400, "Hiker", "The Path to the Croce del Beech is really simple and easily identifiable. It's short, which makes it perfect for beginners and to be ridden all year round.", 87, 88);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (40, "Trail to Fondo and Tallorno", 5, "gpx/Fondo_e_tallorno.gpx", 1278, 1, 1, 4.6, "01:10", 200, 1222, "Tourist", "The path to the Fondo and Tallorno waterfall starts on the left of the bar over the bridge and runs alongside the river on a clearly visible mule track.", 89, 90);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (41, "Trail to Rifugio Arlaud", 6, "gpx/Rifugio_Arlaud.gpx", 1175, 1, 1, 10.0, "03:20", 250, 1800, "Tourist", "The route develops within the Gran Bosco di Salbertrand Natural Park, it is truly suggestive in winter because the snow that covers the trees is a unique spectacle.", 91, 92);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (42, "Trail to Rifugio Amprimo", 6, "gpx/Amprimo.gpx", 1245, 1, 1, 4.53, "01:25", 120, 1385, "Tourist", "The path to the Amprimo Hut from the town of Cortavetto is an easy destination for everyone, even those approaching the mountain for the first time, but no less fascinating for this.", 93, 94);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (43, "Anello Augusto Monti", 6, "gpx/Sentiero_Augusto_Monti.gpx", 1115, 1, 1, 8.5, "02:30", 270, 814, "Tourist", "The start of the itinerary is in the immediate vicinity of the hamlet, there are panels that intend to show the origin of the itinerary.", 95, 96);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (44, "Trail to Monte Muretto", 6, "gpx/Monte_Muretto.gpx", 1191, 1, 1, 4.3, "01:40", 270, 820, "Tourist", "Particularly easy excursion and suitable for the whole family, also for the beautiful panorama visible from the top, obviously if the weather permits.", 97, 98);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (45, "Trail to Lago Fauri", 6, "gpx/Lago_Fauri.gpx", 1201, 1, 1, 22.5, "07:30", 1273, 2857, "Hiker", "ou reach the locality of Pattemouche, shortly after the main town of Pragelato, and continue by car along the road until you reach a large dirt clearing, before a bridge over the Chisone stream.", 99, 100);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
VALUES (50, "Trail to lake Mongioia and Monte Mongioia", 6, "gpx/Lago_e_Monte_Mongioia.gpx", 4017, 4, 1, 15.0, "08:00", 1250, 1858.365722999999889, "Hiker", "After Chiazale, follow the signs for Sant'Anna di Bellino and once you get there, continue for another 500m following the signs for the Meleze' refuge.", 109, 110);
INSERT INTO "Hike"("hikeId", "title", "writerId", "trackPath", "city", "province", "region", "length", "expectedTime", "ascent", "maxElevation", "difficulty", "description", "startPoint", "endPoint")
...
INSERT INTO "Hut"("hutId", "hutName", "pointId", "writerId", "city", "province", "region", "numOfBeds", "cost", "altitude", "phone", "email", "website")
VALUES (5, "Rifugio Amici Della Montagna Condove'", 131, 2, 1093, 1, 1, 100, 80.0, 1254.22, "328 022 2365", "bronzinomarco@gmail.com", "www.amicidellamontagnacondove.it");
