...
const testHutPoint1 = new Point(1, "hut", 0, 1, null, 45.090428, 7.675735);
const testHutPoint2 = new Point(2, "hut", 0, 1, null, 20.0, 20.0);
const testHutPoint3 = new Point(3, "hut", 0, 1, null, 30.0, 30.0);
const testHut1 = new Hut(1, "testName1", testHutPoint1.pointId, testUserLocalGuide.userId, 1272, 1, 1, 1, 10.0, 1000.0, "391012345678", "testHutEmail1@email.com", "www.testHutWebSite1.com",`hutImage/${testHutImage}`);
...
describe("POST /api/huts/", function () {
  ...
  Utils.postHut(
    agent,
    "return 401 because of writer is unauthorized",
    401,
    wrongCredentials,
    testHut1.hutName,
    testHut1.city,
