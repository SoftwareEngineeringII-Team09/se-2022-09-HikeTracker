...
const testRefPoint4 = new Point(4, "reference point", 0, 0, "testRefPointName4", 40.0, 40.0, 40.0);
const testStartPoint1 = new Point(5, "start point", 0, 0, "Start point of testHike1", 50.0, 50.0, 50.0);
const testEndPoint1 = new Point(6, "end point", 0, 0, "End point of testHike1", 60.0, 60.0, 60.0);
const testStartPoint2 = new Point(7, "start point", 0, 0, "Start point of testHike2", 70.0, 70.0, 70.0);
const testEndPoint2 = new Point(8, "end point", 0, 0, "End point of testHike2", 80.0, 80.0, 80.0);
